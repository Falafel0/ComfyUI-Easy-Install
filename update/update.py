    ...
    for remote in repo.remotes:
        if remote.name == remote_name:
            try:
                ...
                subprocess.check_call(['git', 'fetch', remote_name], cwd=repo.workdir)
...
if False and self_update and not files_equal(update_py_path, repo_update_py_path) and file_size(repo_update_py_path) > 10:
